...
Figure \ref{usecase_1_datastructure} shows the data structure of the
neural network after adding the definition.

\begin{figure}
\centering
\includegraphics[width=15.00000cm]{images/usecase_1_datastructure}
