...
functionality would be to expose the evaluation as a web service. Client
applications could run their requests against the trained models instead
of on-device recognition.
