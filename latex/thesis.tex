...
\tightlist
\item
  Top left: score vs iteration chart - this is the value of the loss
  function on the current minibatch
\item
...
\item
  Bottom right: Standard deviations (vs.~time) of: activations,
...
\item
  Learning rate vs.~time (note this will be flat, unless learning rate
  schedules are used)
\end{itemize}
