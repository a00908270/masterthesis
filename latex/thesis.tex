...
which implements n-dimensional array objects (tensors) for Java. It is a
library, that is optimized for GPU processing with a CUDA backend and
supports all common operations to manipulate matrices. Parts of core are
written in C++ to increase performance of numerical operations.
