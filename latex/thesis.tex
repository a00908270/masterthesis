...
\subsection{Training Sequence Diagram}\label{training-sequence-diagram}
...
ain services that expose a RESTful API to users and two supporting
services in charge of persisting data. Figure
\ref{img.overview_main_services} shows an overview of these services.
