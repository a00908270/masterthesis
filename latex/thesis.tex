...
The documentation is provided in Section \ref{rest-api-documentation} or
online on SwaggerHub (https://app.swaggerhub.com/apis/a00908270/).
...
Developers can use any Java Based development environment, like eclipse
or \{\{IntelliJ\}\}.
